...
## Configure additional Attestation Types and Definitions

1. Configure the _environment.ts_/_environment.ts_

```
jar_mode: 'by_reference' or 'by_value'

attestation: [
    {
        key: ... ,
        value: ... ,
        scheme: ..., -> optional: wallet scheme for the attestation
        name: ..., -> name of the attestation to be dysplayed in the ui page
        format: [
            {
                type: "mso_mdoc",
                doctype: ...,
...
2. Configure the _.env_ (best for docker deployment)

The same content as the environment.ts but written in a single line.
